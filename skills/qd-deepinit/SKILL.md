---
name: qd-deepinit
description: Deep codebase initialization with hierarchical AGENTS.md documentation — creates comprehensive AI-readable documentation across the entire codebase
triggers:
  - /qd-deepinit
  - create AGENTS.md
...
Adapted from [oh-my-claudecode/deepinit](https://github.com/Yeachan-Heo/oh-my-claudecode)
